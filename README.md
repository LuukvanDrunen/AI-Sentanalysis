...
The sentanalysis.yml file is used to create a conda enviorment with all the required packages already installed.
...
This folder also contains three csv files, one containing the human-rated gold-label, one containing the ai labeled tweets and one containing both the human and ai labeled tweets and the number of tweets with a label that differs between the human labeled and ai labeled.
